...
A media file will not be downloaded if the file already exists on the local hard drive and
...
Modified the codec to support Bayer encoding and decoding as specified in VC-5 Part 3.
