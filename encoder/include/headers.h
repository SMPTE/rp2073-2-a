...
// The metadata header file in the encoder directory tree is no longer used
//#include "metadata.h"

// Use the Expat library to parse the XML file containing the metadata
#include <expat.h>

// Include the headers for the XML parser
#include "metadata.h"
#include "parser.h"
